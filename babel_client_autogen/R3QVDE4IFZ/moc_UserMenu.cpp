...
#include "src/client/GUI/UserMenu.h"
...
QT_MOC_LITERAL(4, 35, 4), // "call"
QT_MOC_LITERAL(5, 40, 14), // "setSelectioned"
QT_MOC_LITERAL(6, 55, 7), // "UserApp"
QT_MOC_LITERAL(7, 63, 3), // "usr"
QT_MOC_LITERAL(8, 67, 8), // "getCallW"
QT_MOC_LITERAL(9, 76, 5) // "Call*"

    },
    "UserMenu\0addContact\0\0removeContact\0"
    "call\0setSelectioned\0UserApp\0usr\0"
    "getCallW\0Call*"
};
...
void UserMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->removeContact(); break;
        case 2: _t->call(); break;
        case 3: _t->setSelectioned((*reinterpret_cast< UserApp(*)>(_a[1]))); break;
        case 4: { Call* _r = _t->getCallW();
            if (_a[0]) *reinterpret_cast< Call**>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
}
